...
namespace ArduinoThermostat
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Set_Tray_Contextmenu();

            // subscribe to settings's show system tray event checkbox
            settingsWindow.useTrayIcon_checkbox.CheckedChanged += new System.EventHandler(this.Settings_UseTrayIcon_Checkbox_CheckedChanged);
        }

        #endregion

        private void Settings_UseTrayIcon_Checkbox_CheckedChanged(object sender, EventArgs e)
        {
            notifyIcon.Visible = !notifyIcon.Visible;
        }

        private void Set_Tray_Contextmenu()
        {
            this.trayContextMenu = new System.Windows.Forms.ContextMenu();

            this.trayMenuItem_Exit = new System.Windows.Forms.MenuItem();
            this.trayMenuItem_Settings = new System.Windows.Forms.MenuItem();
            this.trayMenuItem_ShowHide = new System.Windows.Forms.MenuItem();

            this.trayContextMenu.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] { this.trayMenuItem_Exit,
                                                                                          this.trayMenuItem_Settings,
                                                                                          this.trayMenuItem_ShowHide});

            this.trayMenuItem_ShowHide.Index = 0;
            this.trayMenuItem_ShowHide.Text = "Show/Hide Arduino Thermostat";
            this.trayMenuItem_ShowHide.Click += new System.EventHandler(this.TrayMenuItem_ShowHide_Click);

            this.trayMenuItem_Settings.Index = 1;
            this.trayMenuItem_Settings.Text = "Settings";
            this.trayMenuItem_Settings.Click += new System.EventHandler(this.TrayMenuItem_Settings_Click);

            this.trayMenuItem_Exit.Index = 2;
            this.trayMenuItem_Exit.Text = "E&xit";
            this.trayMenuItem_Exit.Click += new System.EventHandler(this.TrayMenuItem_Click);

            notifyIcon.ContextMenu = this.trayContextMenu;
            notifyIcon.Text = "Arduino Thermostat";
        }
        private void TrayMenuItem_ShowHide_Click(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                this.Hide();
        ...
        private void TrayMenuItem_Settings_Click(object sender, EventArgs e)
        {
            settingsWindow.Show();
        }
        ...
        private void Init_form()
        {
            ...
            notifyIcon.Visible = Properties.Settings.Default.showInTray; // set system tray

            // set form attributes from settings
        ...
        {
            if (Properties.Settings.Default.showInTray)
            {
                this.Hide();
                settingsWindow.Hide();
            }
        ...
        private void Save_And_Exit()
        {
            ...
            // restrict boundaries of form location x and y so it doesn't start off screen
            if (this.Location.X < 0)
            {
                mainFormLocationX = 0;
            }
            else if (this.Location.X > SystemInformation.VirtualScreen.Width - this.Size.Width)
            {
                mainFormLocationX = SystemInformation.VirtualScreen.Width - this.Size.Width;
            }
            else
            {
                mainFormLocationX = this.Location.X;
            }
            if (this.Location.Y < 0)
            {
                mainFormLocationX = 0;
            }
            else if (this.Location.Y > SystemInformation.VirtualScreen.Height - this.Size.Height)
            {
                mainFormLocationY = SystemInformation.VirtualScreen.Height - this.Size.Height;
            }
            else
            {
                mainFormLocationY = this.Location.Y;
            }
            Properties.Settings.Default.mainFormLocation = new Point(mainFormLocationX, mainFormLocationY);
        ...
        // minimize by clicking the taskbar icon
